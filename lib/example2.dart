...
class QuillExample2 extends StatefulWidget {
  const QuillExample2({super.key});

  @override
  State<QuillExample2> createState() => _QuillExample2State();
}

class _QuillExample2State extends State<QuillExample2> {
            ...
            child: Wrap(
              children: [
                ...
                textButton(
                    ...
                    onPressed: () async {
                      // var delta = await controller.getDelta();
                      var data = await controller.getPlainText();
                      print(data);
                      // debugPrint(jsonEncode(controller));
                    }),
              ],
